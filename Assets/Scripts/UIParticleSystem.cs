...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIParticleSystem : MaskableGraphic
    {
        ...
        private void StopActionCallback()
        {
            gameObject.SendMessage("OnParticleSystemStopped");
        }
        ...
        protected override void Awake()
        {
            ...
            switch (mainModule.stopAction)
            {
                case ParticleSystemStopAction.Callback:
                    Invoke(nameof(StopActionCallback), mainModule.duration + mainModule.startLifetime.constantMax);
                    break;
                case ParticleSystemStopAction.Destroy:
                    Destroy(this,mainModule.duration + mainModule.startLifetime.constantMax );
                    break;
            }
        }
